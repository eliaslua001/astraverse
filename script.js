...
},
{
  ...
  facts: [
    ...
    'Mars is known as the "Red Planet" due to its reddish appearance. Due in part to the iron minerals oxidising on the Martian surface.',
    ...
    'Mars has a similar rotation to Earth (23.9 hours) as it completes one rotation in 24.6 hours. ',
    'Mars\' axial tilt is also similar to Earth at 25° and doe xperiences season. However Martian\'s seasons last longer as it orbits The Sun further away.',
    'Mars have two moons, Phobos and Deimos, that are shaped like a potatoes as their gravity is too weak to main a spherical shape.',
    ...
    'While Mars\' is about half the diameter to Earth, its surface has nearly the same area as Earth\'s dry land.',
    'Mars is home to the largest volcano in our Solar System, Olympus Mons. It is three tiems as taller than Earth\'s Mount Everest.',
    'Water exists on the Martian\'s surface as water-ice in the polar regions',
    'Martian\'s temperature can be as high as 20°C and as low as -153°C. This is due to the thin martian atmosphere where the heat from the sun easily escapes the planet.',
  ]
},
{
  id: 'jupiter',
